//! `rustsqlite-core` — a faithful, file-format-compatible reimplementation of the SQLite3 engine.
//!
...
// root so callers can write `rustsqlite_core::sqlite3_open(...)` directly.
